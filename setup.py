...
includefiles = [os.path.join('packages', 'application.py')] #include path of your personnal module if they are not located in the same directory of your main script
binaries = []
excludes = []
options = {
    'build_exe': {    
